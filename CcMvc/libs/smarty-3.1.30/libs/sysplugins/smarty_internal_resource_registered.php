...
class Smarty_Internal_Resource_Registered extends Smarty_Resource
{
    ...
    public function getTemplateTimestamp(Smarty_Template_Source $source)
    {
        // return timestamp
        $time_stamp = false;
        /* $fun = $source->smarty->registered_resources[$source->type][0][1];
          $fun(...array($source->name, &$time_stamp, $source->smarty)); */
    ...
    public function getContent(Smarty_Template_Source $source)
    {
        ...
        $content = null;
        /* $fun = $source->smarty->registered_resources[$source->type][0][0];
          $t = $fun(...array($source->name, &$content, $source->smarty)); */
